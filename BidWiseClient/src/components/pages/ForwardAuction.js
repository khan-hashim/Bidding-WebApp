  ...
  return (
    <div className="mainContainer">
      <div className="PhotoAndHighBidInfo">
        ...
        <h1>Highest Bidder: {auctionInfo.highestbidder} </h1>
      </div>
      ...
      <div className="ItemInfo">
        ...
        <p className="pcss">
          {" "}
          <strong className="colorblk">Item Description:</strong>
          {auctionInfo.itemdesc}{" "}
        </p>

        <p className="pcss">
          <strong className="colorblk">Condition:</strong>
          {auctionInfo.itemdesc}{" "}
        </p>
        ...
        <div className="bidds">
          ...
          ></input>
          <button onClick={handleBid} style={{ marginTop: "0px" }}>
            Place A Bid
          </button>
        </div>
      </div>
